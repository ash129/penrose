#' The iterative penrose tiling plotting function
#'
#' \code{penrose()} recursively component of the penrose deflation starting with a shape
...
penrose= function(xs, ys, type, iter, final.iter, core.x, core.y, core.r, 
  ...
  if(iter + 1 > final.iter){
    ...
    if(type == "kite"){
      ...
      penrose(xs= new.points$k1$xs, ys= new.points$k1$ys, 
              ...
              ticker= ticker)
      penrose(xs= new.points$k2$xs, ys= new.points$k2$ys, 
              type= "kite", iter= iter + 1, final.iter= final.iter, core.x= core.x, core.y= core.y, core.r= core.r, 
              kite= kite, dart= dart, core.rot= core.rot, core.sca= core.sca, cent.rot= cent.rot, cent.sca= cent.sca, 
              ticker= ticker)
      penrose(xs= new.points$d1$xs, ys= new.points$d1$ys, 
